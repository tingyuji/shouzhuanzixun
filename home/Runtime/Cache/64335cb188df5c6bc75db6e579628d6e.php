  ...
  <div class="nav-wrap">
    <div class="nav" >
      <ul>
        ...
        <li>
          <a href="__URL__/index2" class="active">安卓有米</a>
        </li>          
        <li>
  ...
  <div id="foo">
    <div id="banner" style="text-align: center;">
      <a target="_blank" href="__URL__/items" target="_blank">
        <img src="http://qstatic.zuimeia.com/img/covers/cld/2018010515025498991_640x360.jpeg" style="widht:640px;height:360px;" />
      </a>
    </div>
    ...
    <div class="items">
      <ul>
        ...
        <li>
          <a target="_blank" href="__URL__/item/id/20"><img src="http://www.shouzuanwu.com/upload/img/2017/12/25/5a40edbfc60f2.png" alt="手赚资讯" />
          </a>
        </li>
      </ul>
    </div>
    ...
    <div class="items">
      <ul>
        <li>
          <a target="_blank" href="__URL__/item/id/20">
            <img src="http://www.shouzuanwu.com/upload/img/2017/12/25/5a40edbfc60f2.png" alt="手赚资讯" />
          </a>
        </li>
        <li>
