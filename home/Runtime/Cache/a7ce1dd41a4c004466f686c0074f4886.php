  ...
  <div class="nav-wrap">
    <div class="nav" >
      <ul>
        ...
        <li>
          <a href="__URL__/index4" class="active">热门活动</a>
        </li>  
        <li>
  ...
  <div id="foo">
    <div id="banner" style="text-align: center;">
      <a target="_blank" href="__URL__/items" target="_blank">
        <img src="http://qstatic.zuimeia.com/img/covers/cld/2017080711171670345_640x360.jpeg" style="widht:640px;height:360px;" />
      </a>
    </div>
