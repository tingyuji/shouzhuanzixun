...
<script type="text/javascript">
    function rowClick(index){
        ...
        var diag = new Dialog();
            ...
            diag.URL = '__URL__/update6&id='+id;
    ...
    $('#query').click(function () {
        ...
        $('#dg1').datagrid({
            ...
            url: '__URL__/getAllByKeyword6&keyword='+encodeURIComponent(keyword),
            pagination: false
        });
        $('#dg1').datagrid('reload');
    });            
      ...
      <div class="navbox clearfix">
          ...
          <ul class="nav clearfix">
              ...
              -->
                ...
                <li><a href="__URL__/index6" class="nav_04 nav_on04">纠错信息</a></li>
