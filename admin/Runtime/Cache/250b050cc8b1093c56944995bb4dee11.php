   ...
   <div style="margin:0 auto;">
        <div class="content">
            <table>
                <tbody>
                    <tr style="margin:5px;">
                        <td style="width:78px;"><span class="del-order">分类</span></td>
                        <td><input name="type" id="category" style="width:256px;height:25px;margin-top:5px;" type="text" value="<?php echo ($data["category"]); ?>"/></td>                       
                    </tr>
                    <tr style="margin:5px;">
                        <td style="width:78px;"><span class="del-order">关键词</span></td>
                        <td>
                            <textarea id="keyword" style="width:256px;height:25px;margin-top:5px;"><?php echo ($data["keyword"]); ?></textarea>  
                        </td>
                    </tr>                                                                                                     
                </tbody>
            </table>
