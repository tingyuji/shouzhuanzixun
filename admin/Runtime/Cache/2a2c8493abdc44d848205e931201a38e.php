...
<body style="width:350px;height:300px;margin:0 auto;padding:5px;">
        ...
        <div class="content">
            <table>
                <tbody>
                    ...
                    <tr style="margin:5px;">
                        <td style="width:98px;"><span class="del-order">精选类别</span></td>
                        <td><input name="type" id="category" style="width:256px;height:25px;margin-top:5px;" type="text" value=""/></td>                       
                    </tr>
