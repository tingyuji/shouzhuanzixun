...
<script type="text/javascript">
    function rowClick(index){
        ...
        var diag = new Dialog();
            ...
            diag.URL = '__URL__/update2&id='+id;
    ...
    $('#query').click(function () {
        ...
        $('#dg1').datagrid({
            ...
            url: '__URL__/getAllByType2&type='+encodeURIComponent(type),
            pagination: false
        });
        $('#dg1').datagrid('reload');
    });           
        $('#dg1').datagrid({
            ...
            //],            
            //序号  对方网址  对方关键词  QQ  电话  联系人 自己网址  自己关键词  交换时间  备注
            columns: [[
                ...
                { field: 'name', title: '热门标签', width: 150},
    	...
    	<div class="navbox clearfix">
        	...
        	<ul class="nav clearfix">
              ...
              -->
                ...
                <li><a href="__URL__/index2" class="nav_05 nav_on05">友情链接</a></li>
