    ...
    $('#query').click(function () {
        ...
        $('#dg1').datagrid({
            ...
            columns: [[
                ...
                { field: 'point', title: '积分', width: 1000}                           
            ]],
        });
    });
</script>
    ...
    <div class="nav_bg">
      <div class="navbox clearfix">
          ...
          <ul class="nav clearfix">
                ...
                <li><a href="__URL__/index11" class="nav_01 nav_on01">精选类别</a></li>
