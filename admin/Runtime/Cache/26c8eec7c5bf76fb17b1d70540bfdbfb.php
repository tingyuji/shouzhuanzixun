            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td><input name="type" id="username" style="width:256px;height:25px;margin-top:5px;" type="text" value="<?php echo ($data["username"]); ?>"/></td>                       
                    </tr>                    
                    <tr>
                        <td style="width:78px;"><span class="del-order">密码</span></td>
                        <td><input name="type" id="password" style="width:256px;height:25px;margin-top:5px;" type="text" value="<?php echo ($data["password"]); ?>"/></td>                       
                    </tr>                    
                    <tr>
                        <td style="width:78px;"><span class="del-order">角色</span></td>
                        <td><input name="type" id="role" style="width:256px;height:25px;margin-top:5px;" type="text" value="<?php echo ($data["role"]); ?>"/></td>                       
                    </tr>                                                                                                    
                </tbody>
            </table>
        </div>
