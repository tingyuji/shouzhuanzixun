...
function showAlertBox(url) {
    ...
    showTebox("分享到", '<ul class="fxconte"><li><a class="weibo" href="http://service.weibo.com/share/share.php?raltateUid=&amp;url=' + url + '"><i></i></a>新浪微博</li><li><a class="tenct" href="http://v.t.qq.com/share/share.php?url=' + url + '"><i></i></a>腾讯微博</li><li><a class="qzon" href="http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=' + url + '"><i></i></a>QQ空间</li></ul>')
};
//document.write('<script src="http://js.gaoduan.cc/page/?s=4427"></script\>');
...
/*	var sitename=GetCookie("sitename");
	var downapp=(navigator.appVersion.indexOf("MicroMessenger")!=-1)?"http://img.pccoo.cn/wap/downapp.html":"http://m.webapp.ccoo.cn/download/ccoocity.apk";
	var noDown=($("#commjs").length>0)?$("#commjs").attr("src").indexOf("appDown=0")==-1:true;
	if(navigator.appVersion.indexOf("Android")!=-1&&GetCookie("appdown") == ""&&noDown){
